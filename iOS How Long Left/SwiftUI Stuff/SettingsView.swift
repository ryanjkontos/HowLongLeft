...
struct SettingsView: View {
    ...
    init() {
        ...
        sections.append(.init(rows: [.pinned, .hidden, .nicknames]))
    ...
    func getRowView(for type: SettingsViewRow) -> some View {
        ...
        case .pinned:
            IconCell(label: "Pinned Events", iconImageName: "pin.fill", iconBackground: .orange, iconFill: .white)
        }
