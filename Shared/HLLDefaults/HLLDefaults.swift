...
class HLLDefaults {
    ...
    struct complication {
        ...
        static var mirrorCalendars: Bool {
            
                
                get {
                    
                    return !defaults.bool(forKey: "DifferentComplicationCalendars")
                    
                }
                
                set (to) {
                    
                    defaults.set(!to, forKey: "DifferentComplicationCalendars")
    ...
    struct watch {
        ...
        static var largeCurrentCard: Bool {
            
            get {
                
                return !defaults.bool(forKey: "WatchSmallCurrentCard")
                
            }
            
            set (to) {
                
                defaults.set(!to, forKey: "WatchSmallCurrentCard")
                
            }
            
        }
        
        static var largeUpcomingCard: Bool {
            
            get {
                
                return defaults.bool(forKey: "WatchLargeUpcomingCard")
                
            }
            
            set (to) {
                
                defaults.set(to, forKey: "WatchLargeUpcomingCard")
