...
public class SwiftConfettiView: NSView {
    ...
    func setup() {
        colors = [NSColor(red:0.95, green:0.40, blue:0.27, alpha:1.0),
    ...
    func imageForType(type: ConfettiType) -> NSImage? {
